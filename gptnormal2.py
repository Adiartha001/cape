...
def predict_booking_status(no_of_adults, no_of_children, no_of_weekend_nights, no_of_week_nights,
    ...
    output = booking_status_encode.get(int(prediction[0]), "Unknown")
    return output
...
if st.button("Run Test Case 1"):
    hasil = predict_booking_status(
        no_of_adults=2, no_of_children=1, no_of_weekend_nights=2, no_of_week_nights=3,
        type_of_meal_plan='Meal Plan 1', required_car_parking_space=1, room_type_reserved='Room_Type 1',
        lead_time=120, arrival_year=2017, arrival_month=7, arrival_date=15,
        market_segment_type='Online', repeated_guest=0, no_of_previous_cancellations=0,
        no_of_previous_bookings_not_canceled=2, avg_price_per_room=100.0, no_of_special_requests=1
    )
    st.success(f"Hasil Test Case 1: {hasil}")

# --- Test Case 2 ---
st.subheader("Test Case 2")
if st.button("Run Test Case 2"):
    hasil = predict_booking_status(
        no_of_adults=1, no_of_children=0, no_of_weekend_nights=0, no_of_week_nights=1,
        type_of_meal_plan='Not Selected', required_car_parking_space=0, room_type_reserved='Room_Type 2',
        lead_time=5, arrival_year=2018, arrival_month=1, arrival_date=3,
        market_segment_type='Offline', repeated_guest=1, no_of_previous_cancellations=1,
        no_of_previous_bookings_not_canceled=0, avg_price_per_room=75.0, no_of_special_requests=0
    )
    st.success(f"Hasil Test Case 2: {hasil}")
